	...
	return (
		<div className={styles.detail_page}>
			...
			<div className="container">
				<div className={styles.content}>
					<div
						className={styles.top + " " + "col-12 col-md-10 m-auto"}
					>
            <div
            ...
            ></div>
					...
					<div className="col-12 col-md-10 m-auto">
						...
						<div className={styles.spc}>
							<span>“</span>
							<p>
								Curabitur varius eros et lacus rutrum consequat.
								Mauris sollicitudin enim condimentum, luctus
						...
						<div>
							<p>
								<strong>
									Check and stock up these 20 items
								</strong>
							</p>
							<p>
								Check and stock up these 20 items Aenean et
								egestas nulla. Pellentesque habitant morbi
								tristique senectus et netus et malesuada fames
								ac turpis egestas. Fusce gravida, ligula non
								molestie tristique, justo elit blandit risus,
								blandit maximus augue magna accumsan ante. Duis
								id mi tristique, pulvinar neque at, lobortis
								tortor.
							</p>
						</div>
					</div>
					...
					<div className="col-12 col-md-10 m-auto">
						...
						<p>
							Etiam vitae leo et diam pellentesque porta. Sed
							eleifend ultricies risus, vel rutrum erat commodo
							ut. Praesent finibus congue euismod. Nullam
							scelerisque massa vel augue placerat, a tempor sem
				...
				<div className="col-12 col-md-10 m-auto">
					...
					<div className={styles.comment + " " + "d-flex flex-wrap"}>
						<div
							className={styles.avatar + " " + "col-12 col-md-2"}
						>
							<Image
								alt="Iamge"
